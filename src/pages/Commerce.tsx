...
import priceList from "@/data/services/e-commerce/price-list.json";
import infoList from "@/data/services/e-commerce/info-list.json";
import infoData from "@/data/services/e-commerce/intro.json";
import faq from "@/data/services/e-commerce/faq.json";
import data from "@/data/services/e-commerce/detail-slider.json";
...
const Commerce = () => {
  ...
  return (
    <>
      <PageMeta title="Ecommerce" description="Web Design" />
      <Intro data={infoData} />
